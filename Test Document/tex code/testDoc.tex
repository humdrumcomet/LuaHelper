    ...
    \mainmatter
        \section{Q1: Bulk Micromachining}
            ...
            \subsection{Mask and Plate Thicknesses}
                ...
                \siluVal[1e-6]{etchTime(0.8e-6,300e-6,362)}{\micro\meter} thick, 
                and the remaining \ch{SiO2} layer will be 
                \siluVal[1e-6]{etchTime(5e-9,3e-6,362)}{\micro\meter} thick.
        ...
        \section{Q2: Surface Micromachining}
            \subsection{Comparing Stresses}
                ...
                \siluVal[1e-6]{etchDimA(500e-6, 290e-6)}{\micro\meter} wide, and 
                ...
                \siluVal[1e-6]{etchDimA(500e-6, 290e-6)/5}{\micro\meter}.


        \clearpage
        \section{Lua Code}
            All code was executed through lualatex
            \lstinputlisting[language={[5.3]Lua}]{\codePath/Assignment1.lua}
